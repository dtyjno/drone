...
#ifndef OFFBOARD_CONTROL__WAYPOINT__TRAJECTORYGENERATOR_H_
#define OFFBOARD_CONTROL__WAYPOINT__TRAJECTORYGENERATOR_H_
...
#endif  // OFFBOARD_CONTROL__WAYPOINT__TRAJECTORYGENERATOR_H_
